...
This repository is commented in Chinese by [prince](princewang1994@gmail.com) just for learning implementation of Keras -- a high availability deep learning framework based on `Tensorflow` and `Theano`. Keras is a uniform interface of `tf` and `th`. Many **Deep Learning** tricks will be demostrated during process of implementation. So it is really worth for reading.
